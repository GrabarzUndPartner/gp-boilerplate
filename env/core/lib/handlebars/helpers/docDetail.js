...
// const template = require('./doc/template.hbs');
...
module.exports = function (assemble) {
    return function (options, cb) {
        // var test = assemble.preRender('docs/detail');
        // // test.compile(this.view, { data: { html: 20002000200020002000200020002000 } }).renderSync().content;
